...
import static util.Interpolation.sqlVersionOfInverseDistanceWeightingAlgorithm;

public class ParquetSQL {
    public static void main(String[] args) {
        ...
        Dataset<Row> output = sqlVersionOfInverseDistanceWeightingAlgorithm(spark, knownPoints, unknownPoints);
